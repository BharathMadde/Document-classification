...
export default function UnlockModal({ section, onUnlock, onCancel }) {
    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <Title>This section is locked</Title>
          <Section>Enter admin code to unlock <b>{section && section.charAt(0).toUpperCase() + section.slice(1)}</b></Section>
          <form style={{ width: '100%' }} onSubmit={handleUnlock} autoComplete="off">
            <Field>
              <Input
                type="password"
                id="unlock-code"
